...
neutron_config () {
	...
	crudini --set $neutronfile DEFAULT bind_host 127.0.0.1
	...
	crudini --set $neutronfile keystone_authtoken password servicepassword
...
neutron_ml2_ini () {
	...
	crudini --set $neutronini ovn ovn_nb_connection tcp:10.0.0.30:6641
	crudini --set $neutronini ovn ovn_sb_connection tcp:10.0.0.30:6642
...
neutron_ovn_metadata_agent() {
	...
	crudini --set neutron_ovn_agent DEFAULT nova_metadata_hostdlp.srv.world
	crudini --set neutron_ovn_agent DEFAULT nova_metadata_protocolhttps
	crudini --set neutron_ovn_agent DEFAULT metadata_proxy_shared_secretmetadata_secret
	...
	crudini --set neutron_ovn_agent ovn ovn_sb_connectiontcp:10.0.0.30:6642
}
